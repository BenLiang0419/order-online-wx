<template>
	<view class="container">
		<view style="padding-left:30rpx;padding-right: 30rpx;padding-top: 45rpx;">
			<!-- user box begin -->
		...
		<view class="service-box">
			...
			<!-- banner begin -->
			<view class="d-flex just-content-center" style="padding-top: 10rpx;padding-bottom: 50rpx;">
				<button type="primary" v-if="isLogin">退出登录</button>
			</view>
			<!-- bennaer end -->
		</view>
		<!-- service box end -->
